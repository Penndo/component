...
class CellPaddingSetting extends React.Component {
    ...
    render(){
        const {type, area, data, typeName, getValue,resizeCellMarker} = this.props;
        return (
            <div>
                <p>{type}</p>
                {
                    ...
                    <div className={styles["cellPadding"]+" "+styles["bodyPadding"]}>
                        <TextInput labelDisplay={"block"} defaultValue = {data[area+"_top"]} typeName = {typeName} propertyName={area+"_top"} label = "top" readOnly={false} getValue={getValue} resizeCellMarker = {resizeCellMarker}/>
                        ...
                        <TextInput labelDisplay={"block"} defaultValue = {data[area+"_bottom"]} typeName = {typeName} propertyName={area+"_bottom"} label = "bottom" readOnly={false} getValue={getValue} resizeCellMarker = {resizeCellMarker}/>
